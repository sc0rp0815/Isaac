...
PKG_ZIP="${PKG_ZIP:-$HOME/storage/shared/Gpt-isaac/deploy/isaac_latest_state_package.zip}"
TARGET_DIR="${1:-/storage/emulated/0/Gpt-isaac/deploy/isaac_latest_state_runtime}"
...
mods = [
    "config","audit","logic","memory","privilege","sudo_gate","decomposer","dispatcher","search",
    "regelwerk","empathie","watchdog","relay","executor","browser","ki_dialog","ki_skills",
    "background_loop","monitor_server","tool_registry","secrets_store","tool_runtime","learning_engine",
    "trust_engine","dashboard_api","instincts","values","meaning","value_decisions","reflection"
]
